...
void OverScene::Initialize()
{
	...
	// -- タイトルのUI -- //
	titleUITex_[0] = TextureManager::LoadTexture("Resources/AssignmentTexture/UI/lose.png");
...
void OverScene::Update(GameManager* gameManager)
{
	...
	// -- 地球 更新 -- //
	planeModelWorldTransform_.rotate_.y -= 0.0015f;
	planeModelWorldTransform_.rotate_.y += 0.05f;
	planeModelWorldTransform_.rotate_.z += 0.025f;
